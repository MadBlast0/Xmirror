...
License:        GPLv3+
URL:            https://github.com/MadBlast0/XMirror
Source0:        https://github.com/MadBlast0/XMirror/archive/%{gittag}/%{name}-%{version}.tar.gz

Packager:       MadBlast0 <https://github.com/MadBlast0>
...
# Note that XMirror does not have a "GPL exception" allowing it to be
...
%files
%{_bindir}/xmirror
%{_bindir}/xmirror-beacon.py
%{_bindir}/xmirror_beacon_module_BlueZ.py
%{_bindir}/xmirror_beacon_module_BleuIO.py
%{_bindir}/xmirror_beacon_module_HCI.py
%{_mandir}/man1/xmirror.1*
%{_mandir}/man1/xmirror-beacon.1*

%doc
%{_docdir}/%{name}/README.txt
%{_docdir}/%{name}/README.html
%{_docdir}/%{name}/README.md
%{_docdir}/%{name}/systemd/xmirror.service
...
%changelog
* Thu Aug 27 2026 MadBlast0 <https://github.com/MadBlast0>
  Initial XMirror release, an AirPlay mirroring server for Windows and Linux.
