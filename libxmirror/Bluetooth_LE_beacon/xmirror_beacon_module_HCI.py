...
#----------------------------------------------------------------
# HCI_Linux (uses sudo hciconfig):  module for a standalone python-3.6 or later AirPlay Service-Discovery Bluetooth LE beacon for XMirror 
...
# (3) add the users who will run xmirror-beacon.py to the group hciusers
...
if linux:
    ...
    * for older FreeBSD releases is available at the XMirror Wiki site:    *
    * https://github.com/MadBlast0/XMirror/wiki/hccontrol-patch-FreeBSD  *
    ***********************************************************************
    '''
    ...
    '''
help_text3 = '''
     (3) add users of xmirror_beacon_module_HCI.py to the group "hciusers"
'''
...
print('loaded xmirror_beacon_module_HCI')
