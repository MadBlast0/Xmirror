...
#----------------------------------------------------------------
# BlueZ/D-Bus (Linux) module for a standalone python-3.6 AirPlay Service-Discovery Bluetooth LE beacon for XMirror 
...
print(f'loaded xmirror_beacon_module_BlueZ ')
